        ...
        <div class="row">
            ...
            <!-- ************************* -->
                    ...
                    <div class="col-12 col-md-6 py-2">
                        ...
                        <input type="text" name="firstName" value="${ doctor.firstName }" class="form-control" id="doctorFirstName"  required/>
                    </div>
                    <div class="col-12 col-md-6 py-2">
                        <label for="doctorLastName" class="form-label">Last name</label>
                        <input type="text" name="lastName" value="${ doctor.lastName }"  class="form-control" id="doctorLastName"  required/>
                    </div>

                    <div class="col-12 col-md-12 py-2">
                      <label for="doctorspecialties" class="form-label">doctor's specialty</label>
                      <input type="text" name="speciality" value="${ doctor.speciality }"  class="form-control" id="doctorspecialties"  required/>
                  </div>
                    ...
                    <div class="col-12 col-md-6 py-2">
                        ...
                        <input type="text" class="form-control"  id="doctorConfirmPassword"  required/>
                    </div>
                    ...
                    <div class="col-12 col-md-6 py-2">
                      ...
                      <div class="col-12 col-md-6 py-2">
                        ...
                        <input type="tel" name="phone" value="${doctor.phone}"  class="form-control" id="doctorPhone"  required/>
                    </div>
                    <div class="col-12 col-md-6 py-2">
