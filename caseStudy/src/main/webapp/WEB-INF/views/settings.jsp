            ...
            <div class="row py-5">
                <form action="saveSettings" method="POST" class="row">
                    ...
                    <div class="col-12 col-md-6 py-2">
                        ...
                        <input type="text" name="name" value="${company.name }" class="form-control" id="companyName"  required/>
                    </div>
                    <div class="col-12 col-md-6 py-2">
                    ...
                    <div class="col-12 col-md-6 py-2">
                        ...
                        <input type="tel" name="phone" value="${company.phone }" class="form-control" id="companyPhone"  required/>
                    </div>
                    <div class="col-12 col-md-6 py-2">
                    ...
                    <div class="col-12 col-md-6 py-2">
                        ...
                        <input type="tel" class="form-control" name="mobile" value="${company.mobile }" id="companyMobile"  required/>
                    </div>
                    <div class="col-12 col-md-6 py-2">
                        <label for="companyFax" class="form-label">fax number</label>
                        <input type="tel" name="fax" value="${company.fax }" class="form-control" id="companyFax"  required/>
                    </div>
                    ...
                    <div class="col-12 col-md-12 py-2">
                        ...
                        <input type="text" name="address" value="${company.address }" class="form-control" id="employeeAdress" placeholder="1234 Main St" required>
                    </div>
                      <div class="col-12 col-md-3 py-2">
                        <label for="companyCountry" class="form-label">country</label>
                        <input type="text" name="country" value="${company.country }" class="form-control" id="companyCountry" placeholder="USA" required>
                      </div>
                      <div class="col-12 col-md-3 py-2">
                        <label for="companyCity" class="form-label">City</label>
                        <input type="text" name="city" value="${company.city }" class="form-control" id="companyCity" required>
                      </div>
                      <div class="col-6 col-md-3 py-2">
                        <label for="companyState" class="form-label">State</label>
                        <input type="text" name="state" value="${company.state }" id="companyState" class="form-control"  required/>
                      </div>
                      <div class="col-6 col-md-3 py-2">
                        <label for="companyZip" class="form-label">Zip</label>
                        <input type="number" name="zip" value="${company.zip }" class="form-control" id="companyZip" required>
                      </div>

                      <div class="col-12 col-md-12 py-2">
                        <label for="companyWebsite" class="form-label">web site</label>
                        <input type="text" name="website" value="${company.website }" class="form-control" id="companyWebsite" placeholder="HTTPS://WWW.NANOCARE.COM" required>
                      </div>
