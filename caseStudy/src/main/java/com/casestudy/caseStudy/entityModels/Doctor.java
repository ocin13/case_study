...
public class Doctor {
	...
	public Doctor(Integer docId, String lastName, String firstName, String speciality, String userName, String password, String dateOfBirth,
	...
	//generate getters and setters for all the Doctor class fields
	...
	public String toString() {
		return "Doctor [docId=" + docId + ", firstName=" + firstName + ", lastName=" + lastName + ", speciality="
				+ speciality + ", userName=" + userName + ", password=" + password + ", dateOfBirth=" + dateOfBirth
				+ ", gender=" + gender + ", street=" + street + ", apt=" + apt + ", city=" + city + ", state=" + state
				+ ", zip=" + zip + ", phone=" + phone + ", email=" + email + ", fileName=" + fileName + ", filePath="
